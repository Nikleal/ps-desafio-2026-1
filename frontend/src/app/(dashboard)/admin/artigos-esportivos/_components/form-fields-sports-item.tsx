    ...
    <>
      <FormFieldsGroup>
        ...
        <FormField> 
          ...
          <Input name="name" id="name" placeholder="Insira o nome do produto" defaultValue={sportsItem?.name} 
            disabled={pending} readOnly={readOnly} error={error?.errors?.name} />
        </FormField>
        ...
        <FormField> 
          ...
          <Input name="brand" id="brand" placeholder="Insira o nome da marca" defaultValue={sportsItem?.brand} 
            disabled={pending} readOnly={readOnly} error={error?.errors?.brand} />
        </FormField>
        ...
        <FormField> 
          ...
          <Input name="year" id="year" maxLength={4} placeholder="Insira o ano do produto" defaultValue={sportsItem?.year} 
            disabled={pending} readOnly={readOnly} error={error?.errors?.year} />
        </FormField>
        ...
        <Label htmlFor="amount" required={!sportsItem}>
          ...
          <Input name="amount" id="amount" type="number" min="1" placeholder="Insira a quantidade do produto" defaultValue={sportsItem?.amount} 
            disabled={pending} readOnly={readOnly} error={error?.errors?.amount} />
        </FormField>
